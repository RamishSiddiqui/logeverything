"""
Smart decorator example for LogEverything.

This example demonstrates the usage of the smart unified decorator
that automatically detects whether it's being applied to a function,
method, or class, and applies the appropriate logging behavior.
"""
...
def main():
    ...
    # Set up with development profile for better visibility
    logger = Logger("smart_decorator_demo")
